sap.ui.define([
	...
	return Opa5.extend("opensap.manageproducts.MaganeProducts.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["opensap/manageproducts/MaganeProducts/localService/mockserver"], function (mockserver) {
