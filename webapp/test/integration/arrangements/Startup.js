sap.ui.define([
	"sap/ui/test/Opa5",
	"opensap/manageproducts/MaganeProducts/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function(Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("opensap.manageproducts.MaganeProducts.test.integration.arrangements.Startup", {
		...
		iStartMyApp : function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "opensap.manageproducts.MaganeProducts",
					async: true
				},
				hash: oOptions.hash,
